...
export const GetVanndors = async (req: Request, res: Response, next: NextFunction) : Promise<any> => {
...
const Admin = {CreateVandor, GetDeliveryUsers, GetTransactionById, GetTransactions, GetVandorByID, GetVanndors, VerifyDeliveryUser};
